...
def casino_screen():
    ...
    while running:
        ...
        choice_info_colour = draw_functions.change_rect_colour(const.choice_Info_button, mouse_pos)
        red_colour_button_colour  = draw_functions.change_rect_colour(const.red_colour_button, mouse_pos)
        black_colour_button_colour  = draw_functions.change_rect_colour(const.black_colour_button, mouse_pos)
        right_choice_colour = draw_functions.change_rect_colour(const.right_choice_button, mouse_pos)
        left_choice_colour = draw_functions.change_rect_colour(const.left_choice_button, mouse_pos) 
        right_choice1_colour = draw_functions.change_rect_colour(const.right_choice1_button, mouse_pos)
        left_choice1_colour = draw_functions.change_rect_colour(const.left_choice1_button, mouse_pos) 
        right_choice2_colour = draw_functions.change_rect_colour(const.right_choice2_button, mouse_pos)
        left_choice2_colour = draw_functions.change_rect_colour(const.left_choice2_button, mouse_pos) 
        right_choice3_colour = draw_functions.change_rect_colour(const.right_choice3_button, mouse_pos)
        left_choice3_colour = draw_functions.change_rect_colour(const.left_choice3_button, mouse_pos) 
        right_choice4_colour = draw_functions.change_rect_colour(const.right_choice4_button, mouse_pos)
        left_choice4_colour = draw_functions.change_rect_colour(const.left_choice4_button, mouse_pos) 
        right_choice5_colour = draw_functions.change_rect_colour(const.right_choice5_button, mouse_pos)
        left_choice5_colour = draw_functions.change_rect_colour(const.left_choice5_button, mouse_pos) 
        right_choice6_colour = draw_functions.change_rect_colour(const.right_choice6_button, mouse_pos)
        left_choice6_colour = draw_functions.change_rect_colour(const.left_choice6_button, mouse_pos) 

        draw_functions.draw_button(const.screen, bet_colour, const.bet_button, "Bet", font, const.black)
        draw_functions.draw_button(const.screen, choice_info_colour, const.choice_Info_button, "Choice Info", font, const.black)
        ...
        draw_functions.draw_button(const.screen, red_colour_button_colour, const.red_colour_button, "->", font, const.black)
        draw_functions.draw_button(const.screen, black_colour_button_colour, const.black_colour_button, "<-", font, const.black)

        draw_functions.draw_button(const.screen, const.blue, const.choice_button, "Choice: " + str(choice), font, const.black)

        draw_functions.draw_button(const.screen, right_choice_colour, const.right_choice_button, "->", font, const.black)
        draw_functions.draw_button(const.screen, left_choice_colour, const.left_choice_button, "<-", font, const.black)
        ...
        if choice == 1:
            ...
            draw_functions.draw_button(const.screen, right_choice1_colour, const.right_choice1_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice1_colour, const.left_choice1_button, "<-", font, const.black)
            ...
            draw_functions.draw_button(const.screen, right_choice2_colour, const.right_choice2_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice2_colour, const.left_choice2_button, "<-", font, const.black)
            ...
            draw_functions.draw_button(const.screen, right_choice3_colour, const.right_choice3_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice3_colour, const.left_choice3_button, "<-", font, const.black)
            ...
            draw_functions.draw_button(const.screen, right_choice4_colour, const.right_choice4_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice4_colour, const.left_choice4_button, "<-", font, const.black)
            ...
            draw_functions.draw_button(const.screen, right_choice5_colour, const.right_choice5_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice5_colour, const.left_choice5_button, "<-", font, const.black)
            ...
            draw_functions.draw_button(const.screen, right_choice6_colour, const.right_choice6_button, "->", font, const.black)
            ...
            draw_functions.draw_button(const.screen, left_choice6_colour, const.left_choice6_button, "<-", font, const.black)
