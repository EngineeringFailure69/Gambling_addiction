...
def pit_boss_screen():
    ...
    while running:
        ...
        draw_functions.load_background_image(const.screen, "assets\\background_photos\\pit_boss_screen_background.png")
        ...
        utils.job_apply(const.apply_button, 6000, 1095, "pit boss")
