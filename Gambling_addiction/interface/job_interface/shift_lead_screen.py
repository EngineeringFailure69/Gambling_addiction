...
def shift_lead_screen():
    ...
    while running:
        ...
        draw_functions.load_background_image(const.screen, "assets\\background_photos\\shift_lead_screen_background.png")
        draw_functions.draw_title(const.screen, const.white, "SHIFT LEADER POSITION")
        draw_functions.draw_text(const.screen, text_messages.shift_lead_job_description, const.white, text_rect, font, line_spacing=5)
        ...
        utils.job_apply(const.apply_button, 4500, 1095, "shift leader")
