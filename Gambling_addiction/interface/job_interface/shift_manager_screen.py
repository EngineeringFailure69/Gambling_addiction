...
def shift_manager_screen():
    ...
    while running:
        ...
        draw_functions.load_background_image(const.screen, "assets\\background_photos\\shift_manager_screen_background.png")
        draw_functions.draw_title(const.screen, const.white, "SHIFT MANAGER POSITION")
        draw_functions.draw_text(const.screen, text_messages.shift_manager_job_description, const.white, text_rect, font, line_spacing=5)
        ...
        utils.job_apply(const.apply_button, 7500, 1095, "shift manager")
