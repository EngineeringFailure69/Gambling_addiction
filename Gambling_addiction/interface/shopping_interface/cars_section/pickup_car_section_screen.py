...
def pickup_car_section_screen():
    ...
    pickup_car_2 = items_class.shop_item("car", "icons\\pickup_car_icon_2.png", "pickup")
    pickup_car_3 = items_class.shop_item("car", "icons\\pickup_car_icon_3.png", "pickup")
    pickup_car_4 = items_class.shop_item("car", "icons\\pickup_car_icon_4.png", "pickup")
    ...
    while running:
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 32500, pickup_car_1)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 36800, pickup_car_2)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 40200, pickup_car_3)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 43500, pickup_car_4)
