...
def sedan_car_section_screen():
    ...
    sedan_car_1 = items_class.shop_item("car", "icons\\sedan_car_icon_1.png", "sedan")
    sedan_car_2 = items_class.shop_item("car", "icons\\sedan_car_icon_2.png", "sedan")
    sedan_car_3 = items_class.shop_item("car", "icons\\sedan_car_icon_3.png", "sedan")
    sedan_car_4 = items_class.shop_item("car", "icons\\sedan_car_icon_4.png", "sedan")
    ...
    while running:
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 25700, sedan_car_1)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 28200, sedan_car_2)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 23900, sedan_car_3)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 27500, sedan_car_4)
