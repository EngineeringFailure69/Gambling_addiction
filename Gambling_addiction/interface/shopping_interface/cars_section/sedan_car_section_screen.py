...
def sedan_car_section_screen():
    ...
    sedan_car_1 = items_class.shop_item("car", "assets\\icons\\shopping_icons\\sedan_car_icon_1.png", "sedan", 25700)
    sedan_car_2 = items_class.shop_item("car", "assets\\icons\\shopping_icons\\sedan_car_icon_2.png", "sedan", 28200)
    sedan_car_3 = items_class.shop_item("car", "assets\\icons\\shopping_icons\\sedan_car_icon_3.png", "sedan", 23900)
    sedan_car_4 = items_class.shop_item("car", "assets\\icons\\shopping_icons\\sedan_car_icon_4.png", "sedan", 27500)
    ...
    while running:
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, sedan_car_1.item_price, sedan_car_1)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, sedan_car_2.image_path, icon_width_screen, icon_height_screen, position_x + icon_width_screen + position_x, position_y)
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, sedan_car_2.item_price, sedan_car_2)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, sedan_car_3.image_path, icon_width_screen, icon_height_screen, position_x + icon_width_screen + position_x + icon_width_screen + position_x, position_y)
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, sedan_car_3.item_price, sedan_car_3)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, sedan_car_4.image_path, icon_width_screen, icon_height_screen, position_x + icon_width_screen + position_x + icon_width_screen + position_x + icon_width_screen + position_x, position_y)
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, sedan_car_4.item_price, sedan_car_4)
