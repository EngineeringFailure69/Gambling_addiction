...
def suv_car_section_screen():
    ...
    suv_car_1 = items_class.shop_item("car", "icons\\shopping_icons\\suv_car_icon_1.png", "suv", 28500)
    suv_car_2 = items_class.shop_item("car", "icons\\shopping_icons\\suv_car_icon_2.png", "suv", 36800)
    suv_car_3 = items_class.shop_item("car", "icons\\shopping_icons\\suv_car_icon_3.png", "suv", 35000)
    suv_car_4 = items_class.shop_item("car", "icons\\shopping_icons\\suv_car_icon_4.png", "suv", 29500)
