...
def smartphones_section_screen():
    ...
    smartphone_1 = items_class.shop_item("electronics", "assets\\icons\\shopping_icons\\smartphone_icon_1.png", "smartphone", 299)
    smartphone_2 = items_class.shop_item("electronics", "assets\\icons\\shopping_icons\\smartphone_icon_2.png", "smartphone", 499)
    smartphone_3 = items_class.shop_item("electronics", "assets\\icons\\shopping_icons\\smartphone_icon_3.png", "smartphone", 199)
    smartphone_4 = items_class.shop_item("electronics", "assets\\icons\\shopping_icons\\smartphone_icon_4.png", "smartphone", 379)
    ...
    while running:
        ...
        draw_functions.draw_button(const.screen, const.smartpgones_bckgd, const.buy_Info_button, "Buy Info", font, const.white)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, smartphone_1.item_price, smartphone_1)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, smartphone_2.item_price, smartphone_2)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, smartphone_3.item_price, smartphone_3)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, smartphone_4.item_price, smartphone_4)
