...
def beds_section_screen():
    ...
    bed_1 = items_class.shop_item("furniture", "icons\\shopping_icons\\bed_icon_1.png", "bed", 550)
    bed_2 = items_class.shop_item("furniture", "icons\\shopping_icons\\bed_icon_2.png", "bed", 720)
    bed_3 = items_class.shop_item("furniture", "icons\\shopping_icons\\bed_icon_3.png", "bed", 620)
    bed_4 = items_class.shop_item("furniture", "icons\\shopping_icons\\bed_icon_4.png", "bed", 650)
