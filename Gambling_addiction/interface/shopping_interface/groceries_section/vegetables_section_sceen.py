...
def vegetables_section_screen():
    ...
    vegetable_1 = items_class.shop_item("groceries", "icons\\shopping_icons\\vegetables_icon_1.png", "vegetables", 0.25)
    vegetable_2 = items_class.shop_item("groceries", "icons\\shopping_icons\\vegetables_icon_2.png", "vegetables", 0.75)
    vegetable_3 = items_class.shop_item("groceries", "icons\\shopping_icons\\vegetables_icon_3.png", "vegetables", 0.30)
    vegetable_4 = items_class.shop_item("groceries", "icons\\shopping_icons\\vegetables_icon_4.png", "vegetables", 0.40)
