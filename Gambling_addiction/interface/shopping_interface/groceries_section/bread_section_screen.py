...
def bread_section_screen():
    ...
    bread_1 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\bread_icon_1.png", "bread", 2.49)
    bread_2 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\bread_icon_2.png", "bread", 1.99)
    bread_3 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\bread_icon_3.png", "bread", 1.29)
    bread_4 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\bread_icon_4.png", "bread", 2.99)
    ...
    while running:
        ...
        draw_functions.draw_button(const.screen, const.bread_bckgd, const.buy_Info_button, "Buy Info", font, const.black)
