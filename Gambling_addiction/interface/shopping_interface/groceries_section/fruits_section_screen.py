...
def fruits_section_screen():
    ...
    fruit_1 = items_class.shop_item("groceries", "icons\\fruit_icon_1.png", "fruit", 1.50)
    fruit_2 = items_class.shop_item("groceries", "icons\\fruit_icon_2.png", "fruit", 2.20)
    fruit_3 = items_class.shop_item("groceries", "icons\\fruit_icon_3.png", "fruit", 1.80)
    fruit_4 = items_class.shop_item("groceries", "icons\\fruit_icon_4.png", "fruit", 1.90)
