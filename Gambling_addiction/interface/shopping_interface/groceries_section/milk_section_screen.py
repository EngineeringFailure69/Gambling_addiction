...
def milk_section_screen():
    ...
    milk_1 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\milk_icon_1.png", "milk", 2.49)
    milk_2 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\milk_icon_2.png", "milk", 3.19)
    milk_3 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\milk_icon_3.png", "milk", 2.79)
    milk_4 = items_class.shop_item("groceries", "assets\\icons\\shopping_icons\\milk_icon_4.png", "milk", 1.99)
    ...
    while running:
        ...
        draw_functions.draw_button(const.screen, const.milk_bckgd, const.buy_Info_button, "Buy Info", font, const.black)
