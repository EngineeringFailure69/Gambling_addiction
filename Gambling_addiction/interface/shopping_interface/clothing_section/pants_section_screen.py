...
def pants_section_screen():
    ...
    pants_1 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\pants_icon_1.png", "pants", 50)
    pants_2 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\pants_icon_2.png", "pants", 65)
    pants_3 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\pants_icon_3.png", "pants", 40)
    pants_4 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\pants_icon_4.png", "pants", 45)
