...
def snees_section_screen():
    ...
    shoe_1 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\shoe_icon_1.png", "snees", 120)
    shoe_2 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\shoe_icon_2.png", "snees", 95)
    shoe_3 = items_class.shop_item("clothes", "assets\\icons\\shopping_icons\\shoe_icon_3.png", "snees", 80)
