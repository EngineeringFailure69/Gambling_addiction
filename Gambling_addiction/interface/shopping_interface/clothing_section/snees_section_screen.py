...
def snees_section_screen():
    ...
    shoe_1 = items_class.shop_item("clothes", "icons\\shoe_icon_1.png", "snees")
    shoe_2 = items_class.shop_item("clothes", "icons\\shoe_icon_2.png", "snees")
    shoe_3 = items_class.shop_item("clothes", "icons\\shoe_icon_3.png", "snees")
    shoe_4 = items_class.shop_item("clothes", "icons\\shoe_icon_4.png", "snees")
    ...
    while running:
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 120, shoe_1)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 95, shoe_2)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 80, shoe_3)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 110, shoe_4)
