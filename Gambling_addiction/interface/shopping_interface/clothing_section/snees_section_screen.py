...
def snees_section_screen():
    ...
    shoe_1 = items_class.shop_item("clothes", "icons\\shopping_icons\\shoe_icon_1.png", "snees", 120)
    shoe_2 = items_class.shop_item("clothes", "icons\\shopping_icons\\shoe_icon_2.png", "snees", 95)
    shoe_3 = items_class.shop_item("clothes", "icons\\shopping_icons\\shoe_icon_3.png", "snees", 80)
    shoe_4 = items_class.shop_item("clothes", "icons\\shopping_icons\\shoe_icon_4.png", "snees", 110)
    ...
    while running:
        ...
        draw_functions.draw_button(const.screen, const.snees_bckgd, const.buy_Info_button, "Buy Info", font, const.white)
