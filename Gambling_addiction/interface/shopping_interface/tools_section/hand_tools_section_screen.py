...
def hand_tools_section_screen():
    ...
    hand_tool_1 = items_class.shop_item("tools", "icons\\hand_tool_icon_1.png", "hand tool")
    hand_tool_2 = items_class.shop_item("tools", "icons\\hand_tool_icon_2.png", "hand tool")
    hand_tool_3 = items_class.shop_item("tools", "icons\\hand_tool_icon_3.png", "hand tool")
    hand_tool_4 = items_class.shop_item("tools", "icons\\hand_tool_icon_4.png", "hand tool")
    ...
    while running:
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 29, hand_tool_1)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 12, hand_tool_2)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 35, hand_tool_3)
        ...
        utils.buy(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_BUY_PRODUCT, 42, hand_tool_4)
