...
def shopping_center_screen():
    ...
    icon_height_screen = const.screen.get_height() / 3 #- const.screen.get_height() / 12
    ...
    while running:
        ...
        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, "icons\shopping_center_furniture_icon.png", icon_width, icon_height, position_x + icon_width + position_x + icon_width + position_x, position_y)
        utils.get_icon_rect_and_handle_click(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_FURNITURE)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, "icons\shopping_center_clothing_icon.png", icon_width, icon_height, position_x, position_y + icon_height + position_y / 2)
        utils.get_icon_rect_and_handle_click(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_CLOTHING)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, "icons\shopping_center_tools_icon.png", icon_width, icon_height, position_x + icon_width + position_x, position_y + icon_height + position_y / 2)
        utils.get_icon_rect_and_handle_click(events, icon_position_x, icon_position_y,  icon_width, icon_height, const.STATE_TOOLS)

        icon_position_x, icon_position_y,  icon_width, icon_height = draw_functions.load_icons(const.screen, "icons\shopping_center_groceries_icon.png", icon_width, icon_height, position_x + icon_width + position_x + icon_width + position_x, position_y + icon_height + position_y / 2)
